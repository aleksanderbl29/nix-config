{ pkgs, ... }: {
  ...
  programs = {
    ...
    oh-my-posh = {
      ...
      settings =
        builtins.fromJSON (builtins.readFile ../dots/oh-my-posh/config.json);
    };
    ...
    zsh = {
      ...
      shellAliases = {
        ...
        # Nix specifics
        nixswitch = if pkgs.stdenv.isDarwin then
        ...
        # R specific
        renv-commit =
          "git add renv.lock && git commit -m 'Update renv snapshot'";
